...
.gallery_item {
    margin: 0;
    flex: 1 1 300px; /* Grow/shrink, base size of 300px */
    max-width: 48%;  /* Two columns on desktop */
}

/* The actual image */
.gallery_image {
    width: 50%;
    height: 300px;   /* Forces consistent height */
    object-fit: cover; /* Crops the image to fill the box without distorting */
    border-radius: 6px;
...
@media (max-width: 600px) {
    .gallery_item {
        max-width: 100%; /* Single column on phones */
    }
}
</style>
